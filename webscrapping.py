...
for pagina in range(1, paginaLimite +1):
    ...
    for card in cards:
        try:
            ...
            # caso exista um link, acessar a pagina individual do filme e capturar os dados.
            if link:
            ...
            #captura dos generos (fallback se nao acessou o link)
            if genero_block:
            ...
            # so adiciona o filme se todos os dados principais existirem
